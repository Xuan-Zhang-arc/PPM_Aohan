...
breaks <- classIntervals(as.numeric(slope_im$v), n = 10, style = "quantile")$brks
breaks <- round(breaks, 2)
plot(slope, breaks = breaks, col = terrain.colors(length(breaks) - 1), main = NULL, axes = TRUE)
plot(Aohan_owin, add = TRUE)
dev.off()
...
breaks <- classIntervals(as.numeric(vis_in_im$v), n = 10, style = "quantile")$brks
breaks <- unique(round(breaks, 2))
custom_colors <- colorRampPalette(c("white", "light green","orange"))(length(breaks) - 1)
plot(visibility_in, breaks = breaks, main = NULL, col=custom_colors, axes = TRUE)
plot(Aohan_owin, add = TRUE)
dev.off()
...
breaks <- classIntervals(as.numeric(vis_out_im$v), n = 10, style = "quantile")$brks
breaks <- unique(round(breaks, 2))
custom_colors <- colorRampPalette(c("grey", "yellow","red"))(length(breaks) - 1)
plot(visibility_out, breaks = breaks, main = NULL, col=custom_colors, axes = TRUE)
plot(Aohan_owin, add = TRUE)
dev.off()
